...
class Edit_Box (QtWidgets.QDialog):
    def __init__(self, n):
        ...
        self.name.setText(config.affairs["affairs"][self.id_box]["name"])
        ...
        self.data.setText(config.affairs["affairs"][self.id_box]["data"])
        ...
        self.text.setText(config.affairs["affairs"][self.id_box]["text"])
        ...
        if config.affairs["affairs"][self.id_box]["priority"] == 1:
            self.priority_1.setChecked(True)
        if config.affairs["affairs"][self.id_box]["priority"] == 2:
            self.priority_2.setChecked(True)
        if config.affairs["affairs"][self.id_box]["priority"] == 3:
            self.priority_3.setChecked(True)

        self.button_apply = QtWidgets.QPushButton(self.frame)
        self.button_apply.setGeometry(QtCore.QRect(710, 210, 32, 32))
